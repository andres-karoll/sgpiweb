...
export default class TusProyectosConvocatoria extends Component {
  ...
  /**
   * metod para cargar proyectos de semillero por la cedula de 
   */
  cargarProyecto = () => {
          ...
          <div>
            <section className="content">
              ...
              <div class="alert alert-info alert-dismissible">
                <h1><i class="fas fa-eye nav-icon"></i>Tus proyetos de convocatoria{this.props.id}</h1>
              </div>
            </section>
          </div>
