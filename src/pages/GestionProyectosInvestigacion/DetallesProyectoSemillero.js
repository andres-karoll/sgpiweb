...
export default class DetallesProyectoSemillero extends Component {
                  ...
                  <div className="card">
                      ...
                      <div className="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="info-box mb-3 bg-info">
                            <span class="info-box-icon"><i class="fas fa-book"></i></span>
                            <div class="info-box-content">
                              <span class="info-box-text">Semillero</span>
                              <span class="info-box-number">{this.state.proyecto.semillero}</span>
                            </div>
                    ...
                    <td className="project-actions text-right" style={{ width: '100%' }}>
                      <div className=" mt-3 pb-3 mb-3 d-flex">
                        ...
                        {
                          rol === "Egresado" || rol === "Estudiante inactivo"|| rol==="Lider grupo investigacion" ||rol==="Coordinador investigacion facultad" || rol==="Direccion investigacion corporativo" || rol==="Semillerista" ? (
                            <></>
                          ) : (
