          ...
          <div className="col-12 col-md-12 col-lg-8 order-2 order-md-1">
            <div className="row">
              ...
              <div className="col-12 col-sm-4">
                <div className="info-box bg-light">
                  <div className="info-box-content">
                    <span className="info-box-text text-center text-muted">Semillero</span>
                    <span className="info-box-number text-center text-muted mb-0">{this.state.proyecto.semillero}</span>
                  </div>
                </div>
              </div>
