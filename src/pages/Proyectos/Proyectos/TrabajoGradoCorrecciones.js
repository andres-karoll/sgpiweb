...
function TrabajoGradoCorrecciones(){
    const [proyectos, setproyectos] = useState([]);
    const [tablaproyectos, settablaproyectos] = useState([]);
    const [busqueda, setbusqueda] = useState("");

    const peticionGet = async()=>{
        await axios.get("http://localhost:8080/gestionproyectosinvestigacion/TrabajoGradoJurado/"+localStorage.getItem("cedula"))
        .then(response=>{
      ...
      <div>
            <section className="content">
                ...
                <div class="alert alert-info alert-dismissible">
                  <h1><i class=" fas fa-cubes  nav-icon"></i>Todos los proyetos en estado de Correcciones hechas por los jurados</h1>
                  </div>
                  </section>
            </div>
...
export default TrabajoGradoCorrecciones;
