...
export default class ProyectosDesarrollo extends Component {
...
status: false,
  ...
  cargarProyecto= () => {
    ...
    var request = "/gestionproyectosinvestigacion/proyectosDesarrolloClase/" +this.props.id;
                    ...
                    <table className="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <NavLink to={"/Evaluacion/" + pro.id} className="btn btn-primary">Evaluar</NavLink>
